...
enum Theme {
    ...
    enum Color {
        ...
        /// — gig and explore fail 4.5:1 contrast as raw values and get
        /// lightened variants there.
        enum Category {
            ...
            /// Categories that pass 4.5:1 return the raw color; the ones
            /// that fail (gig, explore) return a lightened color tuned
            /// to ≥ 4.5:1 against `Theme.Color.surface`.
